...
| 4.4 | Executar o plano de testes (T01–T27 automatizados + manuais 1–4) em Sandbox e corrigir falhas | [15](../specs/15-plano-de-testes.md) | 6 | 2.8, 4.1 | 🟦 | | 21/09: matriz T01–T30 conferida (343 specs verdes), cobertura ≥ 97% nos grupos com `minimum_coverage 90`, registro de QA em `docs/qa/`. Compra mobile ✅ 21/09; falta só o manual do Twilio Sandbox (mesmo pendente da 2.7) |
