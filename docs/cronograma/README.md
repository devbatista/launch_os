...
| 1.6 | Template Direct Response: rota `/:slug`, todos os blocos, mobile first, meta tags e og_image, entry `landing.js` | [06](../specs/06-landing-page.md) | 10 | 1.4, 1.5 | ⬜ | | |
| 1.7 | Preview de rascunho para admin; 404 público para não publicados | [05](../specs/05-catalogo-produtos-admin.md), [06](../specs/06-landing-page.md) | 2 | 1.6 | ⬜ | | |
